...
const initData = [
  { id: 0, caption: 'task 1', completed: false },
  { id: 1, caption: 'task 2', completed: false },
  { id: 2, caption: 'task 3', completed: true },
]
...
describe('ui testing', () => {
  ...
  test('click Update Button invokes dataManager.updateTask method', () => {
    ...
    updateTaskBtn.click()
    expect(app.dataManager.updateTask).toBeCalledWith('updated', { caption: 'updated', completed: false, id: 0 }, 'Bearer token')
  })
})
